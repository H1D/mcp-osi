...
// --- dbt tools ---
server.tool("validate_dbt_semantic_model", "Validate a dbt semantic model YAML against the official dbt JSON Schema. " +
...
server.tool("scaffold_dbt_semantic_model", "Generate a starter dbt semantic model skeleton with entities, dimensions, and measures.", {
    model_name: z.string().describe("Name for the semantic model"),
...
server.tool("get_dbt_spec_reference", "Get the dbt semantic model specification reference, JSON Schema, or examples. " +
